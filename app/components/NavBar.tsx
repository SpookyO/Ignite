...
<section>
  <nav className="font-inter mx-auto h-auto w-full max-w-screen-2xl lg:relative lg:top-0">
        ...
        <div className="flex items-center space-x-3 px-6 py-6 lg:flex-row lg:items-center lg:justify-between lg:px-10 lg:py-4 xl:px-20">
        
             
            
            <a href="#" className="w-max h-max">  
                <div className="text-4xl font-bold" >Ignite</div>
            </a> 
